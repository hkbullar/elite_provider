...
const LatLng DEST_LOCATION = LatLng(30.7334421,76.7797143);
class MapCheck extends StatefulWidget
{
  @override
  _MapCheckState createState() => _MapCheckState();
}

class _MapCheckState extends State<MapCheck> {
...
// wrapper around the location API
  ...
  void setPolylines() async {
    PolylineResult result = await polylinePoints.getRouteBetweenCoordinates(
        ...
        currentLocation.longitude),PointLatLng(
