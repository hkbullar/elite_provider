            ...
            child: ListView.separated(
                ...
                itemBuilder: (context,index){
                  return Card(elevation: 5.0,
                      ...
                      child: Container(padding: EdgeInsets.fromLTRB(15.0, 10.0, 15.0, 10.0),
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Row(
                              children: [
                                Expanded(
                                  child: CommonWidgets.selectedFontWidget("02-03-2021"+" at "+
                                      "12:25", AppColours.black, 15.0,
                                      FontWeight.bold),
                                ),
                                CommonWidgets.selectedFontWidget("220"+" GHS", AppColours.off_white, 15.0,
                                    FontWeight.bold),
                              ],
                            ),
                            ...
                            Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                              children: [
                                RaisedButton(
                                  ...
                                  child: CommonWidgets.selectedFontWidget("Cancel journey",
                                    AppColours.golden_button_bg, 14.0, FontWeight.w500),),
                                RaisedButton(
                                  elevation: 5.0,
                                  onPressed: (){

                                },color: AppColours.golden_button_bg,
                                  child: CommonWidgets.selectedFontWidget("Start journey",
                                    AppColours.white, 14.0, FontWeight.w500),)
                              ],
                            ),
                          ],
                        ),
